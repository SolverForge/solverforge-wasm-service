...
import org.solverforge.wasm.service.dto.constraint.ComplementComponent;
import org.solverforge.wasm.service.dto.constraint.DataStream;
import org.solverforge.wasm.service.dto.constraint.ExpandComponent;
import org.solverforge.wasm.service.dto.constraint.FilterComponent;
...
import org.solverforge.wasm.service.dto.constraint.ForEachUniquePairComponent;
import org.solverforge.wasm.service.dto.constraint.GroupByComponent;
import org.solverforge.wasm.service.dto.constraint.IfExistsComponent;
import org.solverforge.wasm.service.dto.constraint.IfNotExistsComponent;
import org.solverforge.wasm.service.dto.constraint.JoinComponent;
import org.solverforge.wasm.service.dto.constraint.MapComponent;
...
import static org.solverforge.wasm.service.classgen.DomainObjectClassGenerator.*;
                ...
                for (var annotation : field.getValue().getAnnotations()) {
                    if (annotation instanceof DomainPlanningScore) {
                        return switch (field.getValue().getType()) {
                            ...
                            case "BendableScore" -> BendableScore.class;
                            default -> {
