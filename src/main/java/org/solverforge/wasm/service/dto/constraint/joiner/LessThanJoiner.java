...
public final class LessThanJoiner extends AbstractComparisonJoiner implements DataJoiner {
    public LessThanJoiner() {

    }

    @JsonCreator
    public LessThanJoiner(@Nullable @JsonProperty("map") WasmFunction map,
