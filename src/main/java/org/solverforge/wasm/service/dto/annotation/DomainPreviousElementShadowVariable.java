...
public final class DomainPreviousElementShadowVariable implements ShadowVariableAnnotation {
    @JsonProperty("source_variable_name")
    String sourceVariableName;

    public DomainPreviousElementShadowVariable() {
        this.sourceVariableName = "";
    }

    @JsonCreator
    public DomainPreviousElementShadowVariable(@JsonProperty("source_variable_name") String sourceVariableName) {
        this.sourceVariableName = (sourceVariableName != null) ? sourceVariableName : "";
    }

    @Override
    public Class<? extends Annotation> annotationClass() {
        return PreviousElementShadowVariable.class;
    }
