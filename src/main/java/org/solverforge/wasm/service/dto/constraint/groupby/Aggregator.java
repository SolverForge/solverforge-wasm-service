...
public sealed interface Aggregator
        permits AverageAggregator, CollectAndThenAggregator, ComposeAggregator, ConditionalAggregator, ConnectedRangeAggregator,
        ConsecutiveAggregator, CountAggregator, LoadBalanceAggregator, MaxAggregator, MinAggregator, SumAggregator {
    String name();
