...
public sealed interface StreamComponent
        permits FilterComponent, FlattenLastComponent, ForEachComponent, GroupByComponent, IfExistsComponent,
        IfNotExistsComponent, JoinComponent, PenalizeComponent, RewardComponent {
    String kind();
